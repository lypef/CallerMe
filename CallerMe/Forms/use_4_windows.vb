Public Class use_4_windows
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        If client_id_0 = 1 Then
            If (String.IsNullOrEmpty(TxtAddClient_0.Text) = False And String.IsNullOrEmpty(TxtAddDireccion_0.Text) = False) Then
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        If client_id_1 = 1 Then
            If (String.IsNullOrEmpty(TxtAddClient_1.Text) = False And String.IsNullOrEmpty(TxtAddDireccion_1.Text) = False) Then
    ...
    Private Sub Button10_Click(sender As Object, e As EventArgs) Handles Button10.Click
        If client_id_2 = 1 Then
            If (String.IsNullOrEmpty(TxtAddClient_2.Text) = False And String.IsNullOrEmpty(TxtAddDireccion_2.Text) = False) Then
