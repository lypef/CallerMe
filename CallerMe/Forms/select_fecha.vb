Public Class select_fecha
    ...
    Public _Logs_login As Boolean = False

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If logs_omitir Then
            _Action_Omitir()
        ElseIf _Logs_login Then
            _Action_logs()
        Else
            _Action()
        End If
    ...
    Private Sub _Action_logs()
        If f.ReturnPermission(f.Permission_Access_LOGS) Then
            logs_login.LoadInifecha(Desde, Hasta)
            f.AddForm_Desktop(logs_login, control.Desktop)
            Me.Dispose()
        Else
            f.Alert(f.Alert_NoPermitido, f.Alert_NumberExclamacion)
        End If
