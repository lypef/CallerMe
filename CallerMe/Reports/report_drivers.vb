...
Public Class report_drivers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Calls.report_drivers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_drivers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_drivers = New report_drivers()
        rpt.Site = Me.Site
        Return rpt
    End Function
