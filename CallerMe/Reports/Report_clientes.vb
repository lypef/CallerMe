...
Public Class Report_clientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Calls.Report_clientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_clientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_clientes = New Report_clientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
