...
Public Class report_numbers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Calls.report_numbers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_numbers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_numbers = New report_numbers()
        rpt.Site = Me.Site
        Return rpt
    End Function
